...
function Model({ currentCarIndex, cars }) {
  ...
  }, [garageGLTF, textures, reflexTextures, groundTextures]);
  ...
  function CameraAnimator({ orbitControlsRef }) {
    ...
    const targetPosition =
      width < 500 ? new Vector3(-0.5, 1.1, 2.7) : new Vector3(-0.5, 1.1, 2.5);
        ...
        <Canvas shadows camera={{ position: [-0.5, 0.7, 2.5] }}>
          <Suspense fallback={null}>
            ...
            <primitive
              ...
              scale={cars[currentCarIndex].scale}
              position={cars[currentCarIndex].position}
              rotation={cars[currentCarIndex].rotation}
            />
            ...
            <OrbitControls
              ...
              enableZoom={false}
              enablePan={false}
              minPolarAngle={width < 500 ? Math.PI / 2.64 : Math.PI / 2.7}
              maxPolarAngle={width < 500 ? Math.PI / 2.64 : Math.PI / 2.7}
            />
          </Suspense>
        </Canvas>
      </div>
